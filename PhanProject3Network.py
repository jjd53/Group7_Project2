...
from SymmetricalFault import Fault
...
network.install_solar("SolarBus4", "bus4", 100, 0.65, 0.95)
...
Fault(network, 2, "ltg", 0)   # single line-to-ground fault
Fault(network, 3, "ltl", 0)   # line-to-line fault
Fault(network, 4, "dltg", 0)  # double line-to-ground fault
