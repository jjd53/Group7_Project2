...
network.add_tline("L1","bus2", "bus4", "Bundle 1", "Geometry 1", 10, s.frequency)
network.add_tline("L2","bus2", "bus3","Bundle 1", "Geometry 1", 25, s.frequency)
network.add_tline("L3","bus3", "bus5","Bundle 1", "Geometry 1", 20, s.frequency)
network.add_tline("L4","bus4", "bus6","Bundle 1", "Geometry 1", 20, s.frequency)
network.add_tline("L5","bus5", "bus6","Bundle 1", "Geometry 1", 10, s.frequency)
network.add_tline("L6","bus4", "bus5","Bundle 1", "Geometry 1", 35, s.frequency)
